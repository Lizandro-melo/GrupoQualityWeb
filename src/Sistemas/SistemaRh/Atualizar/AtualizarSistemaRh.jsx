...
export default class AtualizarSistemaRh extends Component {
  ...
  componentDidMount = () => {
    if (this.state.colaborador !== "") {
      this.require.getDadosColaborador(
        this,
  ...
  render() {
    return (
        ...
        >
          <section className="w-3/5 flex flex-col h-2/5 kanit bg-stone-50 rounded-xl shadow-xl">
            <header className="w-full bg-blue-950 h-10 rounded-t-xl flex items-center justify-between px-10">
              <span className="text-white kanit font-semibold">Mensagem</span>
            </header>
                ...
                <button
                  ...
                  onClick={() => {
                    switch (this.state.acao) {
                      case "contratar":
                        this.require.contratarEstagiario(this);
                        break;
                      case "desligar":
                        this.require.desligarColaborador(this);
                        break;
                      case "reativar":
        ...
        <form className="relative top-3 w-full px-20 flex gap-24 justify-center items-start h-full">
          <section className="w-full flex flex-col gap-4">
            <section className="flex flex-col">
              <label className="text-sm" htmlFor="NomeCompleto">
                Nome do colaborador
              </label>
              <select
            ...
            <section className="flex gap-4 max-lg:flex-wrap">
              ...
              <section className="flex gap-1 items-center">
                ...
                <input
                  ...
                  type="radio"
                  checked={
                    this.state.filtroColaborador === "DESLIGADOS" ? true : false
                  }
                />
              </section>
              <section
                className={`h-5 border px-5 text-sm flex ${
                  this.state.situacao === "Desligado"
            ...
            <section className="flex flex-col">
              <label className="text-sm" htmlFor="DataNascimento">
                Data de Nascimento
              </label>
              <input
                className="w-full h-10 px-2 rounded-lg border border-stone-300 text-sm"
            ...
            <section className="flex flex-col">
              <label className="text-sm" htmlFor="Empresa">
                Empresa
              </label>
              <select
                className="w-full h-10 px-2 rounded-lg border border-stone-300 text-sm"
              ...
              >
                <option value="x" selected disabled>
                  {this.state.empresa === "" ? "Empresa" : this.state.empresa}
                </option>
            ...
            <section className="flex flex-col">
              ...
              >
                <option value="x" selected disabled>
                  {this.state.setor === "" ? "Setor" : this.state.setor}
                </option>
                ...
                <option value="16">Logistica - Grupo Quality</option>
              </select>
            </section>
            <section className="flex flex-col">
              <label className="text-sm" htmlFor="">
            ...
            <section className="flex flex-col">
              ...
              <input
                className="w-full h-10 px-2 rounded-lg border border-stone-300 text-sm"
                type="date"
                value={this.state.dataDemissao}
                onChange={(e) => {
                  this.setState({ dataDemissao: e.target.value });
                }}
                disabled={
                  this.state.dataDemissao === "" ||
                  this.state.dataDemissao === ""
                }
              />
            </section>
          ...
          <section className="w-full flex flex-col gap-4">
            ...
            <section className="flex flex-col">
              ...
              >
                <option value="x" selected disabled>
                  {this.state.permissaoSecundaria === ""
                    ? "Permissão Secundaria"
                    : this.state.permissaoSecundaria}
                </option>
                <option value="MASTER">MASTER</option>
            ...
            <section className="flex flex-col">
              ...
              <input
                className=" w-full h-10 px-2 rounded-lg  pt-2 text-sm file:mr-4 file:py-1 file:px-4
      ...
      hover:file:bg-stone-200"
              ...
              />
              <span className="text-xs">Apenas imagens em formato PNG</span>
            </section>
            <section className="flex flex-col">
              <label className="text-sm" htmlFor="">
                Senha
          ...
          <section className="absolute bottom-5 flex gap-2 flex-wrap ">
            ...
            <button
              ...
              className={`hover:bg-stone-200 active:scale-90 h-11 border px-10 bg-white font-semibold ${
                this.state.user.roleSecondary === "MASTER" ? "" : "!hidden"
              } border-stone-400 rounded-lg`}
            >
              Desligar
            </button>
            <button
