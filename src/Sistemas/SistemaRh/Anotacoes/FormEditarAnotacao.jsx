          ...
          <section className="flex gap-5">
            <section className="flex flex-col gap-2">
              <section className="bg-stone-300 w-fit p-0.5">
                <span>Nome do Colaborador: {this.state.colaborador.nome}</span>
              </section>
              <section className="bg-stone-300 w-fit p-1">
                <span>Tipo: {this.state.colaborador.tipo}</span>
              </section>
            </section>
            <img
            ...
            <section className="flex gap-5 text-sm">
              <section className="flex flex-col gap-2">
                <section className="flex flex-col">
                  ...
                  <input
                    className="h-7 border border-stone-300 w-40 pl-2"
                    type="number"
                    value={this.state.horaExtra}
                    onChange={(e) => {
                      this.setState({ horaExtra: e.target.value });
                    }}
                    onFocus={() => this.setState({ horaExtra: "" })}
                  />
                </section>
                <section className="flex flex-col">
                  ...
                  <input
                    className="h-7 border border-stone-300 w-40 pl-2"
                    type="number"
                    value={this.state.bancoPositivo}
                    onChange={(e) => {
                      this.setState({ bancoPositivo: e.target.value });
                    }}
                    onFocus={() => this.setState({ bancoPositivo: "" })}
                  />
                </section>
                <section className="flex flex-col">
                  ...
                  <input
                    className="h-7 border border-stone-300 w-40 pl-2"
                    type="number"
                    value={this.state.bancoNegativo}
                    onChange={(e) => {
                      this.setState({ bancoNegativo: e.target.value });
                    }}
                    onFocus={() => this.setState({ bancoNegativo: "" })}
                  />
                </section>
                <section className="flex flex-col">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      this.selectMotivo(e.target.value);
                    }}
                  >
              ...
              <section className="flex flex-col gap-2">
                <section className="flex flex-col">
                  ...
                  <input
                    className="h-7 border border-stone-300 w-40 pl-2"
                    type="date"
                    value={this.state.dataInicialModalAnotacao}
                    onChange={(e) => {
                      this.setState({
                ...
                <section className="flex flex-col">
                  ...
                  <input
                    className="h-7 border border-stone-300 w-40 pl-2"
                    type="date"
                    value={this.state.dataFinalModalAnotacao}
                    onChange={(e) => {
                      this.setState({
                ...
                <section className="flex flex-col">
                  <label htmlFor="">Atraso</label>
                  <input
                    className="h-7 border border-stone-300 w-40 pl-2"
                    type="number"
                    value={this.state.atraso}
                    onChange={(e) => {
                      this.setState({ atraso: e.target.value });
                    }}
                    onFocus={() => this.setState({ atraso: "" })}
                  />
                </section>
                {this.state.advEscritaCheckbox === true ? (
                  <section className="flex flex-col">
                    <label htmlFor="">Data Adv. Escrita</label>
                    <input
                      className="h-7 border border-stone-300 w-40 pl-2"
                      type="date"
                      value={this.state.dataAdvEscritaModalAnotacao}
                      onChange={(e) => {
                        this.setState({
          ...
          <section>
            <section className="flex gap-2">
              ...
              {this.state.status === false ? (
                <button
                  type="button"
                  className={`bg-white transition-colors border border-stone-300 px-12 h-10 rounded-md cursor-pointer  flex justify-center items-center font-medium hover:text-green-400 hover:border-green-400 ${
                    this.state.responsavel.roleSecondary === "COMUM"
                      ? "hidden"
                      : ""
                  }`}
                  onClick={() => {
                ...
                <button
                  type="button"
                  className={`bg-white transition-colors border border-stone-300 px-12 h-10 rounded-md cursor-pointer  flex justify-center items-center font-medium hover:text-red-400 hover:border-red-400 ${
                    this.state.responsavel.roleSecondary === "COMUM"
                      ? "hidden"
                      : ""
                  }`}
              ...
              <section className="flex gap-1">
                ...
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      atestadoCheckBox:
                        this.state.atestadoCheckBox === false ? true : false,
                    })
                  }
                  checked={this.state.atestadoCheckBox}
                />
              </section>
              <section className="flex gap-1">
                <label>Ferias</label>
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      feriasCheckbox:
                        this.state.feriasCheckbox === false ? true : false,
                    })
                  }
                  checked={this.state.feriasCheckbox}
                />
              </section>
              <section className="flex gap-1">
                <label>Faltou</label>
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      faltouCheckbox:
                        this.state.faltouCheckbox === false ? true : false,
                    })
                  }
                  checked={this.state.faltouCheckbox}
                />
              </section>
              <section className="flex gap-1">
                ...
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      suspensaoCheckbox:
                        this.state.suspensaoCheckbox === false ? true : false,
                    })
                  }
                  checked={this.state.suspensaoCheckbox}
                />
              </section>
              <section className="flex gap-1">
                <label>Licença</label>
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      licencaCheckbox:
                        this.state.licencaCheckbox === false ? true : false,
                    })
                  }
                  checked={this.state.licencaCheckbox}
                />
              </section>
              <section className="flex gap-1">
                ...
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      atestadoHoraCheckbox:
                        this.state.atestadoHoraCheckbox === false
                          ? true
                          : false,
                    })
                  }
                  checked={this.state.atestadoHoraCheckbox}
                />
              </section>
              <section className="flex gap-1">
                ...
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      advEscritaCheckbox:
                        this.state.advEscritaCheckbox === false ? true : false,
                    })
                  }
                  checked={this.state.advEscritaCheckbox}
                />
              </section>
              <section className="flex gap-1">
                ...
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      advVerbalCheckbox:
                        this.state.advVerbalCheckbox === false ? true : false,
                    })
                  }
                  checked={this.state.advVerbalCheckbox}
                />
              </section>
              <section className="flex gap-1">
                <label>Atraso</label>
                <input
                  ...
                  onChange={() =>
                    this.setState({
                      atrasoCheckbox:
                        this.state.atrasoCheckbox === false ? true : false,
                    })
                  }
                  checked={this.state.atrasoCheckbox}
                />
              </section>
            </section>
            <section className="h-full w-full flex flex-col gap-2">
              <section className="flex gap-2 w-full justify-evenly">
                <section className="bg-stone-300 w-fit p-0.5">
                  <span>
                    Responsavel:{" "}
                    {`${this.state.responsavel.nome} ${this.state.responsavel.sobrenome}`}
                  </span>
                </section>
                <section className="bg-stone-300 w-fit p-1">
                  <span>Motivo: {this.state.motivo}</span>
                </section>
              </section>
              <textarea
                className="resize-none border border-stone-400 rounded-xl w-full h-5/6 p-3"
                placeholder="Anotação"
                value={this.state.anotacaoInput}
                onChange={(e) =>
                  this.setState({ anotacaoInput: e.target.value })
                }
              ></textarea>
            </section>
          </section>
