...
import { dataHoje, fecharModalCriarAnotacao } from "./Constant/AnotacoesConstant";
                    ...
                    <section className="flex items-center h-full gap-2">
                        <section className="flex flex-col items-end w-44">
                            <section className="flex gap-1">
                                ...
                                <input type="checkbox" onChange={() => this.setState({ atestadoCheckBox: this.state.atestadoCheckBox === false ? true : false })} />
                            </section>
                            <section className="flex gap-1">
                                <label>Ferias</label>
                                <input type="checkbox" onChange={() => this.setState({ feriasCheckbox: this.state.feriasCheckbox === false ? true : false })} />
                            </section>
                            <section className="flex gap-1">
                                <label>Faltou</label>
                                <input type="checkbox" onChange={() => this.setState({ faltouCheckbox: this.state.faltouCheckbox === false ? true : false })} />
                            </section>
                            <section className="flex gap-1">
                                <label>Suspensão</label>
                                <input type="checkbox" onChange={() => this.setState({ suspensaoCheckbox: this.state.suspensaoCheckbox === false ? true : false })} />
                            </section>
                            <section className="flex gap-1">
                                <label>Licença</label>
                                <input type="checkbox" onChange={() => this.setState({ licencaCheckbox: this.state.licencaCheckbox === false ? true : false })} />
                            </section>
                            <section className="flex gap-1">
                                <label>Atestado Horas</label>
                                <input type="checkbox" onChange={() => this.setState({ atestadoHoraCheckbox: this.state.atestadoHoraCheckbox === false ? true : false })} />
                            </section>
                            <section className="flex gap-1">
                                <label>Adv. Escrita</label>
                                <input type="checkbox" onChange={() => this.setState({ advEscritaCheckbox: this.state.advEscritaCheckbox === false ? true : false })} />
                            </section>
                            <section className="flex gap-1">
                                <label>Adv. Verbal</label>
                                <input type="checkbox" onChange={() => this.setState({ advVerbalCheckbox: this.state.advVerbalCheckbox === false ? true : false })} />
                            </section>
                            <section className="flex gap-1">
                                <label>Atraso</label>
                                <input type="checkbox" onChange={() => this.setState({ atrasoCheckbox: this.state.atrasoCheckbox === false ? true : false })} />
                            </section>
                        </section>
