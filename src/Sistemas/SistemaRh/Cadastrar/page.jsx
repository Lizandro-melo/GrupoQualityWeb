...
//   fecharModalMensagemError = () => {
//     this.setState({
//       mensagemModalError: null,
//       modalStateError: false,
//     });
//   };
...
//         </ReactModal>
//         <ReactModal
//           isOpen={this.state.modalStateError}
//           className="outline-none w-full h-full flex justify-center items-center"
//           onRequestClose={this.fecharModalMensagemError}
//           style={{ overlay: { zIndex: 1000 }, content: { zIndex: 1001 } }}
//         >
//           <section className="w-3/5 flex flex-col h-2/5 kanit bg-stone-50 rounded-xl shadow-xl">
//             <header className="w-full bg-blue-950 h-10 rounded-t-xl flex items-center justify-between px-10">
...
//               <section>
//                 <span className="font-semibold text-xl">
//                   {this.state.mensagemModalError}
//                 </span>
//               </section>
//               <section>
//                 <button
//                   className="bg-white transition-colors border border-stone-300 px-12 h-10 rounded-md cursor-pointer hover:bg-stone-200 flex justify-center items-center font-medium"
//                   onClick={this.fecharModalMensagemError}
//                 >
//                   Ok
//                 </button>
//               </section>
...
//             <button
//               type="submit"
//               className="hover:bg-stone-100 active:scale-90 mt-5 h-11 border w-56 bg-white border-stone-400 rounded-lg"
//             >
